...
object MissingDependencyClassChecker : CallChecker, ClassifierUsageChecker {
    ...
    override fun check(targetDescriptor: ClassifierDescriptor, trace: BindingTrace, element: PsiElement, languageVersionSettings: LanguageVersionSettings) {
